...
-- 2. Show the party and RANK for constituency 
--S14000024 in 2017. List the output by party
SELECT party, votes,
...
--S14000021 in each year. Include yr, party, 
...
--each party in Edinburgh in 2017. Order your results 
...
FROM ge WHERE constituency BETWEEN 'S14000021' AND 'S14000026' AND yr=2017) AS ranks
WHERE posn='1';
...
(SELECT constituency,party,
       RANK() OVER (PARTITION by constituency ORDER BY votes DESC) as posn
FROM ge WHERE constituency LIKE 'S%' AND yr=2017) as ranks
WHERE posn=1
GROUP BY party;